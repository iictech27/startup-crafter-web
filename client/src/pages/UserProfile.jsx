            ...
            <div className={styles.sectionTop}>
                <div className={styles.left_section}>
                    ...
                    <div className={styles.info}>
                        ...
                        <div>
                            <img
                                src="../../public/assets/image 23.png"
                                alt=""
                            />
            ...
            <div className={styles.sectionBottom}>
                ...
                <div className={styles.middleSectionBottom}>
                    <div className={styles.rectangle}>
                        ...
                        <div className={styles.rectangleBox}>
                            <img
                                src="../../public/assets/image 24.png"
                                alt=""
                            />
                            <div>
                        ...
                        <div className={styles.rectangleBox}>
                            <img
                                src="../../public/assets/image 25.png"
                                alt=""
                            />
                            <div>
                                <h3>Blogs</h3>
                ...
                <div className={styles.rightSectionBottom}>
                    <div className={styles.about}>
                        ...
                        <span className={styles.shift}>
                            ...
                            elit. Saepe placeat maiores harum, eligendi
                    ...
                    <div className={styles.education}>
                        ...
                        <span className={styles.shift}>
                            Lorem ipsum dolor, sit amet consectetur adipisicing
                            elit. Ducimus nostrum quia aperiam quis, et
                            adipisci!
                        </span>
                    </div>
                </div>
